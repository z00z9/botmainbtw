    ...
    $.bind('command', function(event) {
        ...
        if (command.equalsIgnoreCase('batfact')) {
            var facts = [
                ...
                'Bats have tendons in their toes which “lock” into place and is able to hold their body weight while hanging upside down. This is how they stay in place for so long!',
                ...
                'Bats have different “supersonic signatures” that sets them apart from each other.  This means they have different “voices” just like humans.',
                ...
                'Dobby is a FREE bat! Google a “baby Goblin Bat”. Not much is known about them except that they look funny. This isn’t a fact, just search for it.',
                ...
                'Palla’s Long-tongued bat has the fastest metabolism of any animal, as 78% of energy comes from recently consumed sugars.',
