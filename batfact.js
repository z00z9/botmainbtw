    ...
    $.bind('command', function(event) {
        ...
        if (command.equalsIgnoreCase('batfact')) {
            var facts = [
                ...
                'The bumblebee bat is the world’s smallest mammal, weighing in at 2 grams and around 1.1 to 1.3 inches in length!',
                ...
                'Honduran White Bats (you’re welcome https://goo.gl/7UvLUF) like to snuggle together in groups inside leaf tents when they sleep! valeHug',
                'There are over 1,300 species of bats! Only 3 of them are vampire bats, who yes, actually do have a blood-based diet.',
                ...
                'Vampire bats have heat-seeking noses that they use to find the warmest spots on their prey, where the blood is closest to the surface.',
                ...
                'The Small Flying Fox Bat uses its wings as an umbrella when it’s raining AND as a fan when it’s too hot!',
                ...
                'Tube-lipped Nectar Bats have tongues that are 1.5 times longer than their bodies. Relative to body size, that’s the longest tongue of any mammal!',
                ...
                'Echolocation is so fine-tuned that bats can detect objects as small and thin as a single human hair.',
                'Bat species that eat frogs can tell the difference between tasty frogs and poisonous frogs by listening to the male frog’s call. Also some bats eat frogs.',
                ...
                'A park next to the Sydney Opera House is home to many giant Flying Foxes that fly freely and live together with really weird-looking birds. Australia is weird.',
                'Evidence found of the earliest bat-like mammal dates back ~50 million years ago.',
                'Vampire bats often remember and return to the same exact prey that they fed on during a previous night.',
                'Small Club-Footed Bats roost INSIDE of bamboo stalks in Southeast Asia.',
                'In West Africa, Small Woolly Bats live in large spider webs. Spooky.',
                'White-Winged Vampire Bats are known to snuggle up to hens and pretend to be one of the chicks, then feed off the mother hen’s blood.',
                'White nose syndrome is a deadly disease that affects nearly every single species of bat. Researchers are trying hard to find a treatment for this disease, since every single species of bat is important to the environment, and to us humans! From pollination to spreading seeds, using enzymes to treat strokes, and pest control, this world can’t live without bats! :(',
                'Bats live happily on every single continent except Antarctica.',
                'Approximately 70% of all species of bat are insect eaters.',
                'In China and Japan, bats have been associated with good fortune throughout history. It’s the opposite in Europe and North America, where bats are associated with witchcraft and evil.',
                'Pipistrelle bats may weigh less than 2 pennies, but can actually eat up to 3,000 bugs in one day.',
                'Dracula originated in Eastern Europe, but vampire bats don’t even live there. They’re actually found in Central & South America.',
                'Bats are easily divided into 2 ‘suborders’ in classification: Megachiroptera (large) and Microchiroptera (small).',
                'The title of Largest Bat Species belongs to the Giant Golden-Crowned Flying Fox. Their wingspan can get up to 5.6 feet (1.7m) long.',
                ...
                'Fewer than 10 people in North America have ever contracted rabies from a bat. They will only bite in self-defense and don’t care much for humans - they just wanna hang out and do their own thing mostly.',
                'The largest bat colony known in the world is located at Bracken Cave in Texas, USA. It holds about 15 million Mexican Free-tailed Bats.',
                ...
                'Little Brown Bats can be taken several hours by car away from their home range and find their way back. Most tropical species get lost if they’re moved even a few miles!',
                'Bats can breathe through their wings - about 10-15% of gas exchange occurs across the wing membrane.',
                'The “fingers” in a bat’s wings are really the third, fourth, and fifth digits (middle, ring, and pinky fingers). The second finger has become reduced and braces the third.',
                ...
                'Pallid bats are immune to scorpion venom, which allows them to be stung by their prey while hunting them and come out unharmed.',
                ...
                'When using echolocation, the closer the bat is to its prey, the quicker the clicks it emits. A “feeding buzz” is when the bat is closest to its prey. Since it is up to 200 clicks per second, it sounds closer to a buzzing noise.',
                ...
                'Vampire bats can leap 7 meters high, which is equivalent to a human jumping over a 7 story building.',
                ...
                'Bats have tendons in their toes which “lock” into place and hold their body weight while hanging upside-down. This is how they stay in place for so long! It also takes absolutely no energy for them to do.',
                'It’s a myth that bats fly left out of a cave. They just fly wherever they want, actually. Usually to me, I’m carrying.',
                'Bats are incredibly agile fliers and are able to turn sharply or move at extremely high speeds. The reason they are so agile is that they can move their wings asymmetrically, while birds can only move their wings symmetrically. Bats also have incredible flexibility and elasticity in their bones - more than any other mammal. This is what sets bat flight apart from bird flight.',
                'Bats belong to the order “Chiroptera” which translates to “hand wing.”',
                'Early human flight ideas/inventions (which da Vinci famously studied) were inspired by the complexity of bat flight.',
                ...
                'Male Dyak Fruit Bats are one of the only known natural occurrences of *male* lactation! They can help feed their young along with the female bats.',
                'Bats do in fact have belly buttons, just like humans.',
                'A baby bat can weigh up to 1/3 of its mother’s body weight. Imagine a human baby being that heavy. That’s a very giant baby.',
                'Male Hammer-Headed Bats honk, and they do it to attract mates. No kinkshaming.',
                ...
                'Fruit bats can detect ripe fruit just by the odor. ms_boogie encourages you to sniff your fruit at the supermarket. Hone your bat abilities, you can do it! BECOME A BAT.',
                'Some bats found in the Panama Canal will lower their heart rate from 1,000 BPM to 200 BPM to avoid starvation when food is scarce, instead of just spamming “I need healing.”',
                'Hardwicke’s Woolly Bats roost inside carnivorous pitcher plants.',
                'Some bats cool off by flying low over water and skimming the surface. Then they can drink the water from their soaked belly fur!',
                'Research on how bats successfully navigate through a colony of hundreds of other bats flying together is inspiring the engineering of safer self-driving cars. Bats are the future.',
                'Egyptian fruit bats have 1,000 different vocalizations and their “dialect” is unique to the colony they are raised in. Only bats that spend a lot of time on the internet will talk a little differently than their colony, particularly smol bats.',
                'Since blood is not very nutritious, Vampire Bats get assistance processing blood from microbes in their guts.',
                'It’s believed that some species of bats are nocturnal just because there is no food competition with birds during the night time.',
                ...
                'Pallas’s Long-Tongued Bat has the fastest metabolism of any animal, as 78% of its energy comes from recently consumed sugars.',
                ...
                'Male Sac-Winged Bats concoct a “perfume” in their wing sacs to attract mates. It’s not made out of sunshine and flowers; you don’t want to know what they make it with...',
                '~72 separate bat species live in the Panama Canal alone.',
                'As you might know, herbivore means “plant-based diet” and carnivore means “meat-based diet”. Sanguivore is a “fresh blood-based diet” and Frugivore is a “fruit-based diet”!',
                ...
                'Common tent-making bats will chew leaf tents in a way that will cause them to fold into shape. Think perforated paper from a notebook!',
                'The longest-living bat ever found was a 41-year-old Brandt’s bat from Russia.',
                'Since bats have abnormally long lifespans for their size, researchers are studying if their genes are particularly resistant to damage. Super bats?',
                ...
                'Some bats, like the Greater Sac-winged Bat roost in the open and rely on camouflage to be protected, unlike cave-dwelling bats.',
                ...
                'In Austin, Texas, Brazilian free-tailed bats were released into the city to combat bug colonies that were threatening the crops. It worked! The bats colonized and have been an invaluable pest control to the crops in Austin.',
                'Eastern Red bats are one of the few species capable of having a larger litter of pups. Because of this, they have four nipples instead of the normal two.',
                ...
                'The Ussurian tube-nosed bat hibernates inside of dens made of snow. (Tiny little bat igloos!) Despite being made of snow, they successfully keep the bats warm throughout the winter.',
                ...
                'Honduran White Bats have left the SPF 100 at home. They have developed a special patch of pigmented tissue on top of their heads that protects them from the sun instead! It’s colored by melanin - something humans also have.',
                'Fruit bats don’t use echolocation, but there is one exception! The Egyptian fruit bat is the only fruit-eating bat known to use echolocation like its bug-eating cousins. It’s used for navigation, and not hunting!',
                'Northern Ghost Bats are known to sing while they eat.',
                'In Mexico, there is a spot called “Volcán de los Murciélagos”, or “Bat Volcano” that was sacred to the Maya, and was believed to be an entrance to the underworld. It “erupts” with bats as dusk falls.',
                'Townsend’s Big-Eared Bat is nicknamed a “whisper bat”, because it uses echolocation at a lower frequency. This is because it primarily hunts moths, and moths are able to pick up on higher frequencies.',
                ...
                'Bats are just as important as bees and butterflies for pollinating plants -- the Pallas’s Long-Tongued Bat’s hair is specifically designed to hold on to pollen particles so the bat can transfer the pollen from plant to plant!',
                ...
                'The Bacardi Bat is one of the world’s most well-known logos. The creators of Bacardi Rum noticed the many fruit bats hanging in the rafters of their Cuban distillery, and thought of them as a sign of good fortune. They weren’t wrong - these fruit bats helped pollinate their sugar cane fields!',
                ...
                'A bat’s brain is very similar to a human’s. Their hippocampus is much like ours, which is important for spatial and social memory. Bats help us understand how our own brains work in a social setting.',
                ...
                'Blood doesn’t rush to the head of an upside-down bat because of special, one-way valves in its arteries! They prevent the blood from flowing backwards.',
                ...
                'Bats can hear anywhere from 20 to 120,000 Hz. For comparison, humans can only hear from 20 to 20,000 Hz.',
                ...
                'Rescued baby bats are swaddled in tiny blanket burritos to mimic being wrapped in their mother’s wings! It keeps them feeling happy, safe, and warm. It also makes them look super cute. Batritos. valeComfy',
                'The rain makes it WAY harder for a bat to use echolocation. The water can refract sound waves, so the raindrops interfere with the bat’s ability to echolocate.',
